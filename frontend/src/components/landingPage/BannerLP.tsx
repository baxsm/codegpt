...
import { bannerCode, bannerWords } from "../../constants/banner";
...
const AnimatedHeaderText = () => {
  ...
  return (
    ...
    <Heading size={size}>&lt; <i className="gradientText">{bannerText}</i> &gt;</Heading>
...
const BannerLP = () => {
  return (
    <div className="flex justify-center place-items-center gap-12 xl:gap-40 min-h-screen xl:flex-row flex-col">
      <div className="flex flex-col gap-6">
        ...
        <Button variant="default" className="w-2/5">Get Started</Button>
        <div className="min-w-[450px] gradientBackground mt-8 rounded-xl">
          <Paragraph className="p-8">
            // Since 2023, more than 25,000 challenges <br /> solved by the members
            of the community //
          </Paragraph>
          <Divider />
